...
const translations = {
  en: {
    ...
    'services.11.title': 'MOTION GRAPHIC',
    'services.11.desc': 'Dynamic motion graphics and video animation.',
  ...
  ar: {
    ...
    'services.11.title': 'موشن جرافيك',
    'services.11.desc': 'فيديوهات موشن جرافيك ورسوم متحركة ديناميكية.',
